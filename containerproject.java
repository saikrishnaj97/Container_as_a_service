...
* Description: ContainerCloudSimExample1 (containerized cloud simulation) Toolkit for Modeling and
Simulation
...
import
org.cloudbus.cloudsim.container.containerSelectionPolicies.PowerContainerSelectionPolicyMaximumUsage;
...
import org.cloudbus.cloudsim.container.resourceAllocatorMigrationEnabled.childclasstomigration;
//import org.cloudbus.cloudsim.container.resourceAllocatorMigrationEnabled.childclasstomigration;
...
/**
* A simple example showing how to create a data center with one host, one VM, one container and run one
cloudlet on it.
*/
...
Log.printLine("Starting Containerproject...");
try {
/**
...
/**
* 3- Defining the VM selection Policy. This policy determines which VMs should be selected for
migration
...
PowerContainerSelectionPolicy containerselectionpolicy=new
...
*/
// double overUtilizationThreshold = 0.5;
// double underUtilizationThreshold = 0.6;
/**
...
//PowerContainerHost h1= new PowerContainerHost(1, null, null, 1, null, null, null);
cloudletList = new ArrayList<ContainerCloudlet>();
vmList = new ArrayList<ContainerVm>();
//ContainerVm abc= vmSelectionPolicy.getVmToMigrate(h1);
//Log.print(abc.getId());
/**
*
*
...
ContainerVmAllocationPolicy vmAllocationPolicy = new
childclasstomigration(hostList,vmSelectionPolicy,
containerselectionpolicy,hostSelectionPolicy,ConstantsExamples.VM_TYPES,
ConstantsExamples.VM_PES,
ConstantsExamples.VM_RAM,
ConstantsExamples.VM_BW,
ConstantsExamples.VM_SIZE,
ConstantsExamples.VM_MIPS);
...
* @throws Exception
*/
public static ContainerDatacenter createDatacenter(String name, Class<? extends ContainerDatacenter>
datacenterClass,
...
ContainerDatacenterCharacteristics(arch, os, vmm, hostList, time_zone, cost, costPerMem,
costPerStorage,
costPerBw);
ContainerDatacenter datacenter = new PowerContainerDatacenterCM(name, characteristics,
vmAllocationPolicy,
containerAllocationPolicy, new LinkedList<Storage>(), schedulingInterval, experimentName,
logAddress,
...
ConstantsExamples.CONTAINER_MIPS[containerType], ConstantsExamples.
CONTAINER_PES[containerType], ConstantsExamples.CONTAINER_RAM[containerType],
ConstantsExamples.CONTAINER_BW, 0L, "Xen",
new
ContainerCloudletSchedulerDynamicWorkload(ConstantsExamples.CONTAINER_MIPS[containerType],
ConstantsExamples.CONTAINER_PES[containerType]), ConstantsExamples.SCHEDULING_INTERVAL));
Log.print(containerType);
}
return containers;
}
/**
...
containerproject.class.getClassLoader().getResource("workload/planetlab").getPath();
